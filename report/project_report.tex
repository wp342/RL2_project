...
Good agents are rewarded for both colliding with the food objects and also mantaining a position within close proximity of the food.
...
Adveraries are rewarded for colliding with good agents while earning a punishment each step in the form of a negative reward proportional to how close good agents are to the food.
More details on the reward sructure of the environment can be found in table \ref{tab:agent-rewards} in Appendix A
